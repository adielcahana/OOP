...
public class AbstractArtDrawing {
    ...
    void drawGraph() {
        ...
        for (int i = 0; i < this.numOfLines; i++) {
            ...
            List squareIntersection = square.intersectionPoints(listOfLines[i]);
            for (int k = 0; k < squareIntersection.size(); k++) {
                d.setColor(Color.GREEN);
                //Draw all the intersection points in red.
                drawPoint((Point) squareIntersection.get(k), d);
            }
