...
public class BlockDefinitionsReader {
    ...
    public static BlocksFromSymbolsFactory fromReader(Reader reader) throws IOException {
        ...
        Map<Integer, String> defaultFill = new TreeMap<Integer, String>();
        ...
        try {
                    ...
                    for (int i = 1; i < parts.length; i++) {
                        ...
                        if (parts2[0].contains("fill")) {
                            ...
                            if (parts2[0].length() > 4) {
                                fillNum = parts2[0].substring(5);
                            } else {
                                fillNum = "1";
                            }
                            defaultFill.put(Integer.parseInt(fillNum), parts2[1]);
                        }
            ...
            try {
                // Return new factory.
                return new BlocksFromSymbolsFactory(defaultDef, defaultFill, blockDef, spaceDef);
