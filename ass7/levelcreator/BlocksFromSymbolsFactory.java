...
public class BlocksFromSymbolsFactory {
     ...
     * @param defaultFill - the map of the default fills for block.
     ...
     * */
    public BlocksFromSymbolsFactory(Map<String, String> defaultDef, Map<Integer, String> defaultFill
            , Map<String, String> blockDef, Map<String, Integer> spaceDef) throws SerializationException {
        setSpaceCreators(spaceDef);
        setBlockCreators(defaultDef, defaultFill, blockDef);
    }
     ...
     * @param blockDef - the parameters of the blocks by symbols.
     * @throws SerializationException - if can't find/read the file. */
    public void setBlockCreators(Map<String, String> defaultDef, Map<Integer, String> defaultFill,
        ...
        while (i.hasNext()) {
            ...
            value = i.next();
            // Every block symbol get the default maps.
            fills.putAll(defaultFill);
            ...
            if (parameters.containsValue(null) || fills.isEmpty()) {
